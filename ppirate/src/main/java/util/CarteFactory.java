...
public class CarteFactory {
    ...
    public static ConfigurationCarte[] creerCartes() {
        ...
        Popularite mainDeFer = new Popularite("Main de fer", 
        ...
        Popularite revolteSimultanee = new Popularite("Révolte simultanée", 
            "Suite à une mutinerie, vous imposez votre autorité et restez capitaine, gagnant ainsi un point de popularité.", 
            1, 0);

        Popularite butinInestimable = new Popularite("Butin inestimable", 
        ...
        Popularite ventEnPoupe = new Popularite("Vent en poupe", 
        ...
        // Cartes d'attaque
        Attaque bombeArtisanale = new Attaque("Bombe artisanale", 
        ...
        Attaque salveDeCanon = new Attaque("Salve de canon", 
        ...
        Protection escrimeDeJeunesse = new Protection("Escrime de jeunesse", 
        ...
        Protection equipageEfficace = new Protection("Equipage efficace", 
        ...
        Protection chapeauBas = new Protection("Chapeau bas", 
        ...
        Protection navireInsubmersible = new Protection("Navire insubmersible", 
        ...
        Protection charismeIntimidant = new Protection("Charisme intimidant", 
